...
const Header = ({ showSidebar, setShowSidebar }) => {
  return (
    ...
    <div className="flex lg:hidden justify-between items-center">
      <button className="p-2 block lg:hidden" onClick={() => setShowSidebar(!showSidebar)}>
        <svg
          className="w-6"
          viewBox="0 0 20 20"
      ...
      <div className="block lg:hidden pt-3">
          <button
            type="button"
            className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  px-3 py-1 text-center me-2 mb-2"
          >
            Register
          </button>
          ...
          <button
            type="button"
            className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300  font-medium rounded-lg  px-3 py-1 text-center me-2 mb-2"
          >
            Login
          </button>
        </div>
      ...
      <div className="flex justify-between items-center mx-5 md:mx-14 lg:mx-20 mb-8 lg:my-12">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-[#3652AD] text-lg md:text-3xl font-medium">
              UDPS Nagpur Alumni Association
            </h1>
            <h2 className="uppercase text-black/80 text-sm md:text-base font-medium">
        ...
        <div className="hidden lg:block">
          <button
            type="button"
            className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2"
          >
            Register
          </button>
          ...
          <button
            type="button"
            className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300  font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2"
          >
            Login
          </button>
        </div>
